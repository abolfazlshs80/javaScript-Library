# ساختار و سرفصل‌های آموزش

لطفاً تمام سرفصل‌های زیر را پوشش بده. برای هر سرفصل، توضیح مقدماتی، توضیح فنی، مثال و نکات مهم ارائه کن.

## 1. مقدمه‌ای بر JavaScript Engine

* JavaScript Engine چیست؟
* چرا JavaScript به موتور اجرا نیاز دارد؟
* آیا JavaScript واقعاً یک زبان Interpreted است؟
* تفاوت زبان برنامه‌نویسی، Compiler، Interpreter و Engine
* JavaScript Engine چه کاری انجام می‌دهد؟
* چه کارهایی خارج از مسئولیت JavaScript Engine است؟
* تفاوت JavaScript Engine با Browser
* تفاوت JavaScript Engine با Rendering Engine
* تفاوت JavaScript Engine با Runtime Environment
* تفاوت JavaScript Engine با Host Environment
* رابطه JavaScript، ECMAScript و JavaScript Engine

### مثال‌های پیشنهادی

* اجرای `console.log("Hello")`
* اجرای یک فایل JavaScript در مرورگر
* اجرای همان فایل در Node.js

---

## 2. تاریخچه JavaScript Engine

* اولین JavaScript Engine چه بود؟
* چرا موتورهای JavaScript در ابتدا ساده بودند؟
* چرا سرعت اجرای JavaScript اهمیت پیدا کرد؟
* نقش مرورگرها در توسعه موتورهای JavaScript
* معرفی کوتاه موتورهای مهم:

  * V8
  * SpiderMonkey
  * JavaScriptCore
  * Chakra (تاریخی)
* تحول موتورهای JavaScript از Interpreterهای ساده تا موتورهای مدرن
* نقش JIT در افزایش سرعت JavaScript

> توجه: تاریخچه را خلاصه اما دقیق بنویس و از بیان تاریخ‌های نامطمئن خودداری کن.

---

## 3. موتورهای معروف JavaScript

برای هر موتور، موارد زیر را توضیح بده:

* نام موتور
* توسعه‌دهنده یا پروژه مرتبط
* محیط‌هایی که از آن استفاده می‌کنند
* ویژگی‌های مهم
* تفاوت کلی با سایر موتورها
* لینک رسمی مستندات
...
در پایان این بخش، یک جدول مقایسه‌ای ساده ارائه کن.

> تأکید کن که JavaScript یک زبان استاندارد است، اما پیاده‌سازی موتورهای آن می‌تواند متفاوت باشد.

---

## 4. JavaScript Engine در مرورگر چگونه کار می‌کند؟

* وقتی یک فایل JavaScript در مرورگر اجرا می‌شود چه اتفاقی می‌افتد؟
* نقش HTML Parser
* نقش JavaScript Engine
* نقش DOM
* نقش Web APIs
* نقش Rendering Engine
* نقش Event Loop
* نقش Call Stack
* نقش Heap
* ارتباط JavaScript Engine با مرورگر
...
Execute
  ↓
Interaction with Host APIs
```

این مسیر را با یک مثال واقعی و قابل‌فهم توضیح بده.
...
* Node.js چیست؟
* آیا Node.js خودش یک JavaScript Engine است؟
* نقش V8 در Node.js
* چه تفاوتی بین اجرای JavaScript در Browser و Node.js وجود دارد؟
* چرا `document` در Node.js وجود ندارد؟
* چرا `window` معمولاً در Node.js وجود ندارد؟
* نقش Node.js APIs
* نقش libuv در Node.js
* ارتباط V8، Node.js و libuv
* آیا Node.js فقط JavaScript را اجرا می‌کند یا امکانات دیگری هم دارد؟
...
توضیح بده کدام بخش توسط V8 و کدام بخش توسط محیط Node.js مدیریت می‌شود.

---

## 6. معماری کلی JavaScript Engine

یک تصویر ذهنی و توضیح مرحله‌به‌مرحله از معماری موتور ارائه کن.
...
> توضیح بده این نمودار یک مدل ساده‌شده است و جزئیات واقعی بین موتورها متفاوت است.

---

## 7. مراحل اجرای کد JavaScript

یک قطعه کد ساده انتخاب کن و اجرای آن را مرحله‌به‌مرحله توضیح بده.
...
2. Parser چه می‌کند؟
3. AST چیست؟
4. آیا همیشه ابتدا Bytecode تولید می‌شود؟
5. Interpreter چه کاری انجام می‌دهد؟
6. چه زمانی کد ممکن است بهینه شود؟
7. Machine Code چیست؟
8. CPU چه چیزی را اجرا می‌کند؟
9. نتیجه چگونه به `console.log` می‌رسد؟
...
* Parsing چیست؟
* چرا موتور باید کد را Parse کند؟
* Token چیست؟
* Lexer یا Tokenizer چیست؟
* Parser چیست؟
* Syntax Error چه زمانی رخ می‌دهد؟
* AST چیست؟
* AST چه کاربردی دارد؟
* تفاوت Source Code و AST
* آیا AST مستقیماً اجرا می‌شود؟
* نقش AST در ابزارهای توسعه‌دهنده
...
نشان بده این کد از نظر مفهومی چگونه به ساختار AST تبدیل می‌شود.

> در صورت نمایش AST، آن را ساده و قابل‌فهم نگه دار.
...
* Interpreter چیست؟
* Interpreter چگونه کد را اجرا می‌کند؟
* آیا Interpreter کد را خط‌به‌خط اجرا می‌کند؟
* تفاوت تصور عمومی از Interpreter با واقعیت موتورهای مدرن
* Bytecode چیست؟
* چرا برخی موتورهای JavaScript از Bytecode استفاده می‌کنند؟
* مزایای Interpreter
* محدودیت‌های Interpreter
* نقش Interpreter در موتورهای مدرن
...
* Compiler چیست؟
* JIT مخفف چیست؟
* Just-In-Time Compilation یعنی چه؟
* تفاوت Ahead-of-Time (AOT) و JIT
* چرا JavaScript از JIT استفاده می‌کند؟
* JIT چگونه در زمان اجرا تصمیم می‌گیرد؟
* آیا همه کدها JIT Compile می‌شوند؟
* مزایا و هزینه‌های JIT
* رابطه Interpreter و JIT Compiler

### مثال ساده

توضیح بده چرا ممکن است یک تابع که بارها اجرا می‌شود، پس از مدتی سریع‌تر اجرا شود.

---

## 11. مراحل بهینه‌سازی در موتورهای مدرن

این بخش را با تمرکز بر V8 توضیح بده، اما روشن کن که جزئیات پیاده‌سازی به موتور وابسته است.

* اجرای اولیه کد
* جمع‌آوری اطلاعات اجرای کد
* شناسایی کدهای پرتکرار
* Profiling
* Type Feedback
* Optimization
* Deoptimization
* بازگشت به اجرای عمومی‌تر
* چرا موتور نمی‌تواند همیشه یک نوع ثابت را فرض کند؟
...
سپس توضیح بده اگر نوع ورودی‌ها تغییر کند چه اتفاقی ممکن است برای بهینه‌سازی رخ دهد.

---

## 12. V8 و اجزای مهم آن

با استفاده از مستندات رسمی V8 توضیح بده:
...
* Sparkplug چیست؟
* Maglev چیست؟
* نقش هرکدام در اجرای JavaScript
* تفاوت Interpreter و Optimizing Compiler در V8
* مفهوم Bytecode در V8
* مفهوم Machine Code در V8
* چرا معماری V8 ممکن است در نسخه‌های مختلف تغییر کند؟

> از ادعای «V8 همیشه دقیقاً این مراحل را طی می‌کند» خودداری کن؛ معماری موتورهای مدرن ممکن است تغییر کند.
...
* چرا با فراخوانی تابع، یک Stack Frame ایجاد می‌شود؟
* Stack Overflow چیست؟
* رابطه Call Stack با اجرای توابع
* تفاوت Call Stack با Heap
...
مراحل ورود و خروج توابع از Call Stack را توضیح بده.
...
* Heap چیست؟
* چه داده‌هایی معمولاً در Heap قرار می‌گیرند؟
* تفاوت Stack و Heap
* آیا همه متغیرها دقیقاً در Stack یا Heap قرار می‌گیرند؟
* چرا نباید درباره محل فیزیکی هر متغیر با قطعیت ساده‌سازی کنیم؟
* Object Allocation چیست؟
* Reference چیست؟
* ارتباط Heap با Garbage Collector
...
توضیح بده موتور از نظر مفهومی چگونه این شیء را مدیریت می‌کند.
...
* چرا JavaScript به Garbage Collection نیاز دارد؟
* Garbage چیست؟
* Reachability چیست؟
* Mark-and-Sweep چیست؟
* Generational Garbage Collection چیست؟
* Young Generation و Old Generation
* Minor GC و Major GC
* Stop-the-World چیست؟
* آیا Garbage Collection همیشه بدون توقف انجام می‌شود؟
* Memory Leak در JavaScript چیست؟
* آیا JavaScript Developer می‌تواند Garbage Collector را مستقیماً کنترل کند؟
...
توضیح بده چرا این شیء ممکن است دیگر قابل‌دسترسی نباشد.

---

## 16. Built-in Objects و Runtime Support

* Built-in Objects چیست؟
* آیا `Array`، `Object`، `Promise` و `Map` بخشی از زبان هستند یا موتور؟
* نقش ECMAScript Specification
* نقش JavaScript Engine در پیاده‌سازی Built-inها
* تفاوت Built-inهای استاندارد با APIهای محیط اجرا
* مثال:
...
* Web API چیست؟
* آیا `setTimeout` بخشی از خود JavaScript Engine است؟
* آیا `fetch` بخشی از ECMAScript است؟
* نقش Browser Host
* نقش DOM
* نقش Timer API
* نقش Fetch API
* نقش Event Target
* تفاوت JavaScript Engine و Web APIs
...
توضیح بده چرا `setTimeout` مستقیماً به معنی اجرای فوری callback نیست.
...
* رابطه Event Loop با Host Environment
* Call Stack
* Task Queue
* Microtask Queue
* Job Queue
...
خروجی را توضیح بده و مشخص کن کدام بخش به ECMAScript و کدام بخش به محیط اجرا مربوط است.

---

## 19. JavaScript Engine و Type System

* JavaScript چه نوع سیستم داده‌ای دارد؟
* Dynamic Typing چیست؟
* چرا موتور باید نوع داده‌ها را در زمان اجرا بررسی کند؟
* Type Feedback چیست؟
* چرا تغییر نوع داده‌ها می‌تواند روی بهینه‌سازی اثر بگذارد؟
* Primitive و Object
* Boxing و Unboxing در صورت ارتباط با موتور
* مفهوم Hidden Class یا Shape
...
توضیح بده موتور از نظر مفهومی با تغییر نوع متغیر چه مواجهه‌ای دارد.

---

## 20. Hidden Classes و Shapes

این بخش را ساده شروع کن و سپس فنی‌تر توضیح بده.

* Hidden Class چیست؟
* چرا موتور برای اشیای JavaScript ساختار داخلی نگه می‌دارد؟
* Shape چیست؟
* Property Layout چیست؟
* چرا ترتیب و نحوه افزودن Propertyها می‌تواند مهم باشد؟
* ارتباط Hidden Class با سرعت دسترسی به Property
* آیا Hidden Class بخشی از استاندارد JavaScript است؟
* تفاوت مفهوم Hidden Class در موتورهای مختلف
...
سپس مثالی از ساخت اشیای با ساختار متفاوت بیاور و توضیح بده چرا ممکن است برای بهینه‌سازی مهم باشد.
...
* Inline Cache چیست؟
* چرا دسترسی مکرر به Propertyها می‌تواند بهینه شود؟
* Monomorphic
* Polymorphic
* Megamorphic
* رابطه Inline Cache با Hidden Class
* آیا Inline Caching بخشی از استاندارد زبان است؟
* چرا تغییر ساختار اشیا می‌تواند روی Performance اثر بگذارد؟
...
توضیح بده موتور چگونه ممکن است این دسترسی را بهینه کند.
...
* Deoptimization چیست؟
* چرا موتور باید گاهی از کد بهینه‌شده خارج شود؟
* چه زمانی فرضیات بهینه‌سازی نادرست می‌شوند؟
* رابطه Deoptimization با Type Feedback
* آیا Deoptimization به معنی خراب شدن موتور است؟
* مثال ساده از تغییر نوع داده یا ساختار شیء
...
* Closure چیست؟
* موتور چگونه متغیرهای خارج از تابع را مدیریت می‌کند؟
* چرا بعضی متغیرها پس از پایان اجرای تابع همچنان زنده می‌مانند؟
* ارتباط Closure با Lexical Environment
* ارتباط Closure با Heap
* آیا Closure باعث Memory Leak می‌شود؟
* چه زمانی Closure می‌تواند حافظه را بیشتر مصرف کند؟
...
* JavaScript Modules چیست؟
* تفاوت Script و Module
* نقش Module Record
* Parsing ماژول‌ها
* Static Import
* Dynamic Import
* آیا Module Loader بخشی از Engine است یا Host؟
* تفاوت Browser و Node.js در Module Loading
* ارتباط Moduleها با Execution Context
...
* آیا `await` یک Thread جدید ایجاد می‌کند؟
* رابطه Promise با Engine
* رابطه Async Function با Event Loop
* آیا `await` اجرای کل JavaScript را متوقف می‌کند؟
* تفاوت توقف تابع با توقف Thread
* مثال مرحله‌به‌مرحله
...
* WebAssembly چیست؟
* چرا برخی موتورهای JavaScript از WebAssembly پشتیبانی می‌کنند؟
* رابطه JavaScript و WebAssembly
* آیا WebAssembly جایگزین JavaScript است؟
* نقش Engine در اجرای WebAssembly
* تفاوت اجرای JavaScript و WebAssembly
* کاربردهای واقعی WebAssembly

---

## 27. JavaScript Engine و چندنخی بودن

* آیا JavaScript تک‌نخی است؟
* منظور از Single-Threaded چیست؟
* آیا JavaScript Engine می‌تواند چند Thread داشته باشد؟
* تفاوت اجرای JavaScript در Main Thread و Worker
* Web Worker چیست؟
* Worker Thread در Node.js چیست؟
* SharedArrayBuffer و Atomics در حد مقدماتی تا متوسط
* تفاوت Parallelism و Concurrency
* آیا وجود چند Thread به معنی اجرای همزمان تمام کدهای JavaScript است؟

---

## 28. JavaScript Engine و Performance

* Performance در JavaScript Engine یعنی چه؟
* چرا بعضی کدها سریع‌تر اجرا می‌شوند؟
* نقش JIT
* نقش Garbage Collector
* نقش Inline Caching
* نقش Hidden Classes
* نقش الگوریتم و ساختار داده
* چرا Microbenchmarkها ممکن است گمراه‌کننده باشند؟
* آیا همیشه باید کد را برای موتور بهینه کنیم؟
* تفاوت Readability و Performance
* مفهوم Premature Optimization
...
* ساخت اشیای متعدد
* تغییر مکرر نوع داده
* ایجاد Allocationهای زیاد

> از ارائه قوانین قطعی و قدیمی مانند «فلان حلقه همیشه سریع‌تر است» خودداری کن؛ رفتار موتور و نسخه آن مهم است.

---

## 29. JavaScript Engine و ابزارهای توسعه‌دهنده

* چگونه می‌توان رفتار موتور را بررسی کرد؟
* Chrome DevTools
* Performance Panel
* Memory Panel
* Console
...
* `console.timeEnd`
* `performance.now`
* ابزارهای مرتبط با Node.js

### مثال

یک مثال ساده برای اندازه‌گیری زمان اجرای کد ارائه کن و محدودیت‌های آن را توضیح بده.
...
* Stack Trace
* Breakpoint
* Call Stack در Debugger
* Source Map
* تفاوت خطای زبان با خطای محیط اجرا
* آیا هر خطا مستقیماً توسط Engine تولید می‌شود؟

---

## 31. JavaScript Engine و امنیت

* چرا Engine باید محیط اجرای امنی فراهم کند؟
* Sandbox چیست؟
* چرا JavaScript مرورگر مستقیماً به فایل‌های سیستم دسترسی ندارد؟
* نقش Browser Security Model
* نقش Host Environment
* آیا Sandbox فقط مربوط به Engine است؟
* تفاوت محدودیت‌های JavaScript در Browser و Node.js
* مفهوم کلی Prototype Pollution و ارتباط آن با اشیای JavaScript، بدون ورود به جزئیات سوءاستفاده

---

## 32. تفاوت استاندارد ECMAScript با پیاده‌سازی Engine

* ECMAScript Specification چیست؟
* TC39 چیست؟
* آیا استاندارد مشخص می‌کند Engine دقیقاً چگونه ساخته شود؟
* تفاوت Specification و Implementation
* چرا دو موتور می‌توانند یک کد را متفاوت بهینه کنند؟
* Compatibility چیست؟
* چرا برخی قابلیت‌ها ممکن است در نسخه‌های مختلف موتور متفاوت باشند؟
* نقش Test262 در سازگاری موتورهای JavaScript

---

## 33. ساخت یک JavaScript Engine ساده — بخش آموزشی پیشرفته

اگر مناسب است، یک موتور بسیار ساده و آموزشی طراحی کن تا مفاهیم زیر روشن شوند:
...
مثلاً موتوری که بتواند کد ساده زیر را تحلیل و اجرا کند:
...
> این بخش باید آموزشی باشد و صریحاً بگو که یک Engine واقعی مانند V8 بسیار پیچیده‌تر است. اگر پیاده‌سازی کامل در یک آموزش منطقی نیست، معماری و شبه‌کد ارائه کن.

---

## 34. باورهای غلط رایج درباره JavaScript Engine

حداقل ۱۰ باور غلط را بررسی کن، مانند:

* JavaScript همیشه خط‌به‌خط اجرا می‌شود.
* JavaScript هیچ‌وقت Compile نمی‌شود.
* JavaScript Engine همان Browser است.
* Node.js همان V8 است.
* Event Loop کاملاً داخل Engine قرار دارد.
* `setTimeout(..., 0)` یعنی اجرای فوری.
* JavaScript همیشه فقط یک Thread دارد.
* Garbage Collector تمام Memory Leakها را حل می‌کند.
* JIT همیشه باعث سریع‌تر شدن همه کدها می‌شود.
* هر متغیر دقیقاً در Stack یا Heap قرار دارد.
* همه موتورهای JavaScript دقیقاً یک معماری دارند.

برای هر مورد، ابتدا باور غلط و سپس توضیح دقیق ارائه کن.

---

## 35. جمع‌بندی نهایی

در پایان، یک جمع‌بندی ساده اما کامل ارائه کن که به این پرسش‌ها پاسخ دهد:

* JavaScript Engine چیست؟
* چه چیزی را اجرا می‌کند؟
* چه مراحلی را طی می‌کند؟
* Interpreter چه نقشی دارد؟
* JIT چه نقشی دارد؟
* Call Stack و Heap چه هستند؟
* Garbage Collector چه می‌کند؟
* Event Loop متعلق به کدام بخش است؟
* تفاوت Engine و Runtime چیست؟
* چرا شناخت Engine برای یک JavaScript Developer مفید است؟

---


لطفاً خروجی را به شکل یک مقاله آموزشی حرفه‌ای برای GitHub Markdown تولید کن.

## 1. فهرست مطالب

در ابتدای مقاله یک **Table of Contents** قرار بده.

* لینک‌های فهرست مطالب باید معتبر و قابل‌استفاده در GitHub باشند.
* عنوان‌ها را طوری انتخاب کن که لینک‌دهی Markdown به‌درستی کار کند.
* اگر مقاله بسیار طولانی شد، پیشنهاد بده چگونه آن را به چند فایل آموزشی تقسیم کنم.

## 2. ساختار هر بخش

برای هر بخش، تا حد امکان از این الگو استفاده کن:
...
- زبان اصلی: **فارسی**
- اصطلاحات تخصصی: انگلیسی داخل پرانتز
- جملات کوتاه و واضح
- پاراگراف‌های طولانی را به چند بخش تقسیم کن.
- از جدول فقط زمانی استفاده کن که واقعاً به مقایسه کمک کند.
- برای مفاهیم پیچیده از نمودارهای متنی استفاده کن.
- کدها باید صحیح، قابل‌اجرا و همراه با توضیح باشند.
- از مثال‌های بیش‌ازحد پیچیده در بخش‌های مقدماتی خودداری کن.

## 4. دقت علمی

- از منابع معتبر و رسمی استفاده کن.
- مطالب مربوط به ECMAScript را از Specification و منابع معتبر استخراج کن.
- مطالب مربوط به V8 را از مستندات رسمی V8 بگیر.
- مطالب مربوط به SpiderMonkey را از مستندات رسمی Mozilla بگیر.
- مطالب مربوط به JavaScriptCore را از منابع رسمی Apple یا WebKit بگیر.
- مطالب مربوط به Browser APIs را از MDN و استانداردهای WHATWG بررسی کن.
- مطالب مربوط به Node.js را از مستندات رسمی Node.js بررسی کن.
- اگر مطلبی وابسته به نسخه موتور است، نسخه یا محدودیت آن را ذکر کن.
- هیچ منبع یا لینکی را حدس نزن.

## 5. منابع در پایان

در پایان مقاله بخشی با عنوان زیر قرار بده:
...
* نام منبع
* توضیح کوتاه درباره اینکه برای کدام بخش استفاده شده
* لینک مستقیم و معتبر

را ارائه کن.

منابع پیشنهادی برای بررسی:

* MDN Web Docs
* ECMAScript Language Specification
* V8 Official Documentation
* Mozilla SpiderMonkey Documentation
* JavaScriptCore / WebKit Documentation
* Node.js Official Documentation
* WHATWG HTML Standard

## 6. نکته مهم درباره سطح آموزش

آموزش را از **صفر** شروع کن، اما در پایان به سطحی برس که خواننده بتواند:

* معماری کلی موتور را توضیح دهد.
* تفاوت Interpreter و JIT را بفهمد.
* مسیر اجرای یک قطعه کد را دنبال کند.
* تفاوت Engine، Runtime و Host را تشخیص دهد.
* نقش Call Stack، Heap و Garbage Collector را توضیح دهد.
* درباره Performance و Deoptimization دید درستی داشته باشد.
* مستندات رسمی موتورهای JavaScript را مطالعه کند.

**خروجی نهایی باید یک آموزش منسجم، دقیق، مبتدی‌پسند و مناسب انتشار در GitHub باشد؛ نه صرفاً مجموعه‌ای از تعریف‌های پراکنده.**


### ASSISTANT
# راهنمای جامع درک JavaScript Engine: از مقدماتی تا پیشرفته

این راهنما برای توسعه‌دهندگانی طراحی شده است که می‌خواهند درک عمیقی از نحوه اجرای کد JavaScript در زیر پوسته (Under the hood) پیدا کنند. این آموزش از مفاهیم پایه شروع شده و به معماری پیشرفته موتورهای مدرن می‌رسد.

> **نکته درباره ساختار:** به دلیل حجم بالای مطالب، این راهنما به‌صورت ماژولار طراحی شده است. اگر قصد انتشار آن در GitHub را دارید، می‌توانید هر بخش اصلی (مثلاً بخش‌های ۱ تا ۵، ۶ تا ۱۲ و ...) را در فایل‌های جداگانه (مانند `01-intro.md`, `02-architecture.md`) قرار داده و از یک فایل `README.md` اصلی به آن‌ها لینک دهید.
