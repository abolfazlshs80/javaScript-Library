...
* توضیحات کاملاً به زبان فارسی باشند.
* لحن ساده و آموزشی باشد.
* فرض کن خواننده هیچ پیش‌زمینه‌ای از JavaScript ندارد.
* ابتدا مفهوم را خیلی ساده توضیح بده، سپس مثال بزن.
* بعد از مثال، خروجی و دلیل خروجی را توضیح بده.
* اصطلاحات مهم انگلیسی را داخل پرانتز کنار معادل فارسی بیاور.
* از توضیحات بیش از حد پیچیده در بخش‌های مقدماتی خودداری کن.
* در بخش‌های پیشرفته می‌توانی وارد جزئیات فنی‌تر شوی.
* مطالب را طوری بنویس که بتوان مستقیماً داخل README یا فایل Markdown Repository قرار داد.

---


در ابتدای مطلب یک Table of Contents کامل ایجاد کن و لینک داخلی برای تمام Headingها قرار بده.
